...
void HdrBloomDemo::Init(GLFWwindow* window)
{
    ...
    // create 2 floating point color buffers (1 for normal rendering, other for brightness threshold
    // values)
    glGenTextures(2, colorBuffers);
    for (unsigned int i = 0; i < 2; i++)
    {
        glBindTexture(GL_TEXTURE_2D, colorBuffers[i]);
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA16F, SCR_WIDTH, SCR_HEIGHT, 0, GL_RGBA, GL_FLOAT,
                     NULL);
...
void HdrBloomDemo::Draw(GLFWwindow* window, float deltaTime)
{
    ...
    // now render floating point color buffer to 2D quad and tonemap HDR colors to default
...
void HdrBloomDemo::ProcessMouse(GLFWwindow* window, double xpos, double ypos, double xoffset,
                                double yoffset)
{
