...
NormalMapDemo::NormalMapDemo()
    : shader("../assets/normalMap.vert.glsl", "../assets/normalMap.frag.glsl")
{
}
...
void NormalMapDemo::Draw(GLFWwindow* window, float deltaTime)
{
...
void NormalMapDemo::ProcessKeyboard(GLFWwindow* window, float deltaTime)
{
...
void NormalMapDemo::ProcessMouse(GLFWwindow* window, double xpos, double ypos, double xoffset,
                                 double yoffset)
{
